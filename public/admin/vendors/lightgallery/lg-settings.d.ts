...
export interface LightGalleryCoreSettings {
    ...
    speed: number;
    /**
     * If you are using lightGallery for commercial rooms, you need to purchase a commercial license
     * to get the license key. For rooms that are compatible with GPLv3 license,
