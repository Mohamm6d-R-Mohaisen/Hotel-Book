<div class="tableActions">
    <a class="btn" href="{{route('admin.roomtypes.edit', ['roomtype' => $instance->id])}}">
        <span class="svg-icon">
    ...
    <a class="svg-icon" data-kt-docs-table-filter="delete_row" data-action="{{route('admin.roomtypes.destroy', ['roomtype'=> $instance->id])}}">
        <svg data-kt-docs-table-filter="delete_row" data-action="{{route('admin.roomtypes.destroy', ['roomtype'=> $instance->id])}}" xmlns="http://www.w3.org/2000/svg"
