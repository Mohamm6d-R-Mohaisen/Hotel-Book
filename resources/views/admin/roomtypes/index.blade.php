                    ...
                    <div class="page-content-header">
                        <div class="row justify-content-between">
                            <div class="col-3 col-sm-12 col-md-3 col-lg-3">
                                <h2 class="table-title">{{ __('admin.global.roomtypes') }}</h2>

                            </div>
                            <div class="col-8 col-sm-12 col-md-9 col-lg-9">
                                <div class="card-toolbar flex-row-fluid d-flex justify-content-end gap-5">
                                    <!--Add new user start-->
                                    <a class="btn btn-primary" href="{{ route('admin.roomtypes.create') }}">
                                        {{ __('admin.global.add_new_categories') }}
...
@push('scripts')
    <script>
        window.datatable_url = "{{ route('admin.roomtypes.datatable') }}";
    </script>
    <script src="{{ asset('admin/js_resource/roomtypes.js') }}"></script>
